...
<head>
   ...
   <style>
      .App-container {
         ...
         border: none;
         border-radius: 5px;
         box-shadow: 0 4px 8px 0 rgba(82, 80, 80, 0.6), 0 6px 20px 0 rgba(0, 0, 0, 0.39);
         margin-left: 25%;
         margin-right: 25%;
         text-align: center;
         background-color: rgb(115, 118, 151);
      ...
      #operatorButton {
         background-color: rgb(209, 183, 168);
      }

      #deleteButton {
         background-color: rgb(163, 116, 111);
      }
